        ...
        <div className="page-shell">
            <section className="page-container pb-10 pt-6">
                <div className="premium-card rounded-[28px] bg-[linear-gradient(180deg,#ffffff_0%,#f3f5f8_100%)] px-6 py-8 sm:rounded-[40px] sm:px-8 sm:py-10 md:px-12 md:py-14">
                    ...
                    <h1 className="text-[clamp(2.1rem,5vw,5rem)] leading-[0.96] sm:leading-[0.92]">14-Day Return Policy on All Certified Premium Apple Devices</h1>
                    <p className="mt-4 max-w-[640px] text-base leading-7 text-ink-soft sm:mt-5 sm:text-lg sm:leading-8">
                        Every certified premium iPhone, iPad, and MacBook purchased from UpCell is covered by a 14-day return window and a 12-month limited warranty. If something isn’t right, we’ll guide you through the process clearly.
                    </p>
                </div>
            </section>
            ...
            <section className="page-container pb-16">
                <article className="legal-prose premium-card rounded-[28px] px-6 py-8 sm:rounded-[36px] sm:px-8 sm:py-10 md:px-12 md:py-14">
                    <p>You have 14 days from delivery to request a return. The fastest route is to email support with your order information and reason for the request.</p>
