                ...
                <div className="contact-grid">
                    <div className="contact-details-side">
                        ...
                        <div className="support-channels">
                            <a href="mailto:usa.globaltraders@gmail.com" className="channel-card">
                                <div className="channel-icon">
                                    <EmailOutlinedIcon />
                                </div>
                                <div className="channel-info">
                                    <h4>Email Support</h4>
                                    <p>usa.globaltraders@gmail.com</p>
                                </div>
                            </a>
                            <a href="https://www.facebook.com/usa.globaltraders" target="_blank" className="channel-card">
                                <div className="channel-icon">
                                    <FacebookOutlinedIcon />
                                </div>
                                <div className="channel-info">
                                    <h4>Facebook Messenger</h4>
                                    <p>facebook.com/usa.globaltraders</p>
                                </div>
                            </a>
                            <a href="https://www.instagram.com/globaltraders_usa/" target="_blank" className="channel-card">
                                <div className="channel-icon">
                                    <InstagramIcon />
                                </div>
                                <div className="channel-info">
                                    <h4>Instagram Direct</h4>
                                    <p>@globaltraders_usa</p>
                                </div>
                            </a>
                        </div>
                    </div>
